			...
			<div class="date_roll_mask">
				<div class="date_roll">
					<div  ref="date_ctrl_div">
						<div class="gear date_yy" data-datetype="date_yy" :val="dateArr.yy" :top="top_yy" :style="'-webkit-transform :translate3d(0,' + top_yy + ',0)'" v-html="yy_itemStr" @touchstart="gearTouchStart" @touchmove="gearTouchMove" @touchend="gearTouchEnd"><!---->
						</div>
						<div class="date_grid">
							<div>年</div>
						</div>
					...
					<div>
						<div class="gear date_mm" data-datetype="date_mm" :val="dateArr.mm" :top="top_mm" :style="'-webkit-transform :translate3d(0,' + top_mm + ',0)'" v-html="mm_itemStr" @touchstart="gearTouchStart" @touchmove="gearTouchMove" @touchend="gearTouchEnd">
